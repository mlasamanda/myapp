...
<input type="text" name="gender" class="form-control" placeholder="Company Email" value="{{ $student->gender }}">
@error('email')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<input type="text" name="dob" value="{{ $student->dob}}" class="form-control" placeholder="Enter physical address">
@error('address')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
